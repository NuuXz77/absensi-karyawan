<div x-data="modal('modal_delete_departemen')">
    @teleport('body')
                ...
                <div class="py-4">
                    ...
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-1 lg:grid-cols-2">
                        ...
                        <fieldset>
                            ...
                            <label class="input w-full input-bordered flex items-center gap-2 bg-base-200">
                                ...
                                <input type="text" wire:model="kode_departemen" class="uppercase" readonly />
                            </label>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <label class="input w-full input-bordered flex items-center gap-2 bg-base-200">
                                ...
                                <input type="text" wire:model="nama_departemen" readonly />
                            </label>
                        </fieldset>
                    ...
                    @if ($karyawan_count > 0)
                        <div class="alert alert-warning mt-4">
                            ...
                            <span>Departemen ini memiliki {{ $karyawan_count }} karyawan. Pastikan untuk memindahkan karyawan terlebih dahulu!</span>
                        </div>
                    @endif
    ...
    <x-partials.toast 
        :success="$showSuccess ? 'Departemen berhasil dihapus!' : null" 
