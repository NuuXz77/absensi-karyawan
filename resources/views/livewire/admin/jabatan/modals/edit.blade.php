<div x-data="modal('modal_edit_jabatan')">
    @teleport('body')
                ...
                <form wire:submit.prevent="update">
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-1 lg:grid-cols-2">
                        ...
                        <fieldset>
                            ...
                            <label
                                class="input w-full validator input-bordered flex items-center gap-2 @error('kode_jabatan') input-error @enderror">
                                <x-heroicon-o-hashtag class="w-4 h-4 opacity-70" />
                                <input required type="text" wire:model="kode_jabatan" placeholder="Contoh: MGR"
                        ...
                        <fieldset>
                            ...
                            <label
                                class="input w-full validator input-bordered flex items-center gap-2 @error('nama_jabatan') input-error @enderror">
                                <x-heroicon-o-briefcase class="w-4 h-4 opacity-70" />
                                <input required type="text" wire:model="nama_jabatan"
    ...
    <x-partials.toast 
        :success="$showSuccess ? 'Jabatan berhasil diupdate!' : null" 
