<div>
    <dialog id="modal_edit_jadwal" class="modal" wire:ignore.self>
        <div class="modal-box max-w-2xl">
            <form method="dialog">
                <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" wire:click="closeModal">✕</button>
            </form>
            <h3 class="text-lg font-bold">Edit Jadwal Kerja</h3>
            ...
            <form wire:submit.prevent="update" class="mt-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 flex justify-end gap-3 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm gap-2" wire:loading.attr="disabled" wire:target="update">
...
<script>
    document.addEventListener('livewire:init', () => {
        Livewire.on('open-edit-modal', () => {
            document.getElementById('modal_edit_jadwal').showModal();
        });
        
        Livewire.on('close-edit-modal', () => {
            document.getElementById('modal_edit_jadwal').close();
        });
    });
</script>
