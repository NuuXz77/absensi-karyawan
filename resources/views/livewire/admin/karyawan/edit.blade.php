                    ...
                    <div class="card bg-base-100 border border-base-300">
                        <div class="card-body">
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                ...
                                {{-- ID Card --}}
                                <fieldset>
                                    <legend class="fieldset-legend">ID Card (Tidak dapat diubah)</legend>
                                    <label
                                        ...
                                        <input type="text" wire:model="id_card" readonly
                                            placeholder="ID Card" class="cursor-not-allowed" />
                                    </label>
                                    <p class="text-xs text-info mt-1">ℹ️ ID Card tidak dapat diubah setelah dibuat</p>
                                    @error('id_card')
                                        <label class="label">
                                            <span class="label-text-alt text-error">{{ $message }}</span>
                                        </label>
                    ...
                    <div class="card bg-base-100 border border-base-300">
                        <div class="card-body">
                            ...
                            <div class="space-y-4">
                                ...
                                @if (!$foto_karyawan && $karyawan->foto_karyawan)
                                    <div class="card bg-base-200 border border-base-300">
                                        <figure class="relative bg-base-300 flex items-center justify-center max-h-[400px] min-h-[300px]">
                                            <img src="{{ Storage::url($karyawan->foto_karyawan) }}" alt="Foto Saat Ini" 
                                                class="max-w-full max-h-[400px] w-auto h-auto object-contain">
                                        </figure>
                                        <div class="card-body p-4">
                                            <div class="flex items-center justify-between">
                                                <div>
                                                    <p class="text-sm font-semibold">Foto Saat Ini</p>
                                                    <p class="text-xs text-base-content/60">Klik tombol di samping untuk mengubah foto</p>
                                                </div>
                                                <label for="foto-upload" class="btn btn-primary btn-sm">
                                ...
                                {{-- Upload Area (Jika belum ada foto atau foto existing dihapus) --}}
                                @if (!$foto_karyawan && !$karyawan->foto_karyawan)
                                    <div class="relative">
                    ...
                    <div class="card bg-base-100 border border-base-300">
                        <div class="card-body">
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                                {{-- Username --}}
                                <fieldset>
                                    <legend class="fieldset-legend">Username (Tidak dapat diubah)</legend>
                                    <label
                                        class="input w-full input-bordered flex items-center gap-2 bg-base-200 cursor-not-allowed">
                                        <x-heroicon-o-user class="w-4 h-4 opacity-70" />
                                        <input type="text" wire:model="username" readonly placeholder="Username" class="cursor-not-allowed" />
                                    </label>
                                    <p class="text-xs text-info mt-1">ℹ️ Username tidak dapat diubah setelah dibuat</p>
                                </fieldset>

                                {{-- Password with Generate Button --}}
                                <fieldset>
                                    <legend class="fieldset-legend">Password (6 Digit - Opsional)</legend>
                                    <div class="join w-full">
                                        ...
                                        <button type="button" wire:click="refreshPassword" class="btn btn-neutral join-item" title="Generate Password Baru">
                                    ...
                                    <p class="text-xs text-info mt-1">ℹ️ Klik refresh untuk mengubah password (opsional)</p>
                                </fieldset>
