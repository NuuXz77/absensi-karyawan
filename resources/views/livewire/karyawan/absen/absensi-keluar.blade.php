        ...
        <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="flex items-center gap-2 p-3 bg-base-200 rounded-lg">
                        ...
                        @else
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="text-xs text-base-content/60">Waktu</div>
                                <div class="text-sm font-semibold text-warning truncate">Belum Waktunya</div>
                            </div>
                        @endif
                    </div>
                    ...
                    @if($jadwal && $jadwal->lokasi)
                        <div class="flex items-center gap-2 p-3 bg-base-200 rounded-lg">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="text-sm font-semibold truncate">{{ $jadwal->lokasi->radius_meter ?? 100 }}m</div>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="card bg-base-100 p-6">
                <button 
                    ...
                    :class="canCapture() ? 'btn-error' : 'btn-disabled'"
                    :disabled="!canCapture()">
                    <x-heroicon-o-camera class="w-6 h-6" />
                    <span class="text-lg">Ambil Foto & Absen Keluar</span>
                </button>
                ...
                <div class="space-y-2 mt-4">
                    ...
                    <div x-show="canCapture()" x-cloak class="alert alert-success py-2">
                        ...
                        <span class="text-sm">Semua validasi terpenuhi! Klik tombol untuk absen keluar</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if($step === 'preview')
        <div class="space-y-4">
            <div class="card bg-base-100 border border-base-300 p-4">
                ...
                <p class="text-sm text-center text-base-content/70 mt-1">Periksa hasil foto sebelum konfirmasi</p>
            </div>
            ...
            <div class="card bg-base-100 border border-base-300 p-6">
                <div class="flex gap-3">
                    <button wire:click="retakePhoto" class="btn btn-outline btn-lg flex-1 gap-2">
                        <x-heroicon-o-arrow-path class="w-5 h-5" />
                        Ambil Ulang
                    </button>
                    <button wire:click="confirmAbsen" class="btn btn-error btn-lg flex-1 gap-2"
    ...
    @if($step === 'success')
        <div class="space-y-4">
            <div class="card bg-base-100 p-8 text-center">
                ...
                <h2 class="text-2xl font-bold text-success mb-2">Absen Keluar Berhasil!</h2>
